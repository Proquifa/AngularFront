...
@Component({
  ...
  templateUrl: './saldo-nota-credito.component.html',
  styleUrls: ['./saldo-nota-credito.component.scss']
})
export class SaldoNotaCreditoComponent implements OnInit {
  itemsMenu: any[];
  usuario: any;
  activeMenu: boolean;
  ...
  title: string;
  itemSelect: any;
  constructor(private core: CoreContainerComponent, private _trabajarArribo: ArriboDocumentoService, private _serviceSaldo: SaldosFavorService, private comun: ComunService) {}
