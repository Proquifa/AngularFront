...
@Component({
  ...
  templateUrl: './barra-prioridades-trabajar-ruta-envio.component.html',
  styleUrls: ['./barra-prioridades-trabajar-ruta-envio.component.scss']
})
export class BarraPrioridadesTrabajarRutaEnvioComponent implements OnInit {
  ...
  constructor(private router: Router, private  _pzasAInspeccionar: InspeccionService, private coreComponent: CoreContainerComponent, private _datosPrio: TrabajarRutasEnvioService ) {}
